...
# -*- coding: utf-8 -*-
"""
Script final - con texto exacto extraído del archivo
"""
...
# Cambio 1: Primer bloque - texto exacto
...
print(f"Ocurrencias del cambio 1: {count1}")

if old1 in content:
    content = content.replace(old1, new1, 1)  # Solo primera ocurrencia
    print("✅ Cambio 1 aplicado")
else:
    print("⚠️  Cambio 1 no encontrado - buscando variaciones...")
    # Intentar sin espacios extras
    old1_alt = old1.replace('                ', '            ')
    if old1_alt in content:
        content = content.replace(old1_alt, new1.replace('                ', '            '), 1)
        print("✅ Cambio 1 aplicado (variación)")

# Cambio 2: Segundo bloque
...
print(f"Ocurrencias del cambio 2: {count2}")

if old2 in content:
    content = content.replace(old2, new2, 1)
    print("✅ Cambio 2 aplicado")
else:
